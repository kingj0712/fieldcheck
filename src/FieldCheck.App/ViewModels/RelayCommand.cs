...
/// <summary>A minimal ICommand that delegates to lambdas. Call <see cref="RaiseCanExecuteChanged"/> to refresh.</summary>
...
/// <summary>A minimal generic ICommand for commands that take a parameter.</summary>
